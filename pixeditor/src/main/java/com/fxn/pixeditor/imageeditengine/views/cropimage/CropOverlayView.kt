...
class CropOverlayView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    internal var mCropWindowChangeListener: CropWindowChangeListener? = null
    ...
    private fun drawCorners(canvas: Canvas) {
        if (mBorderCornerPaint != null) {
            ...
            val cornerOffset = ((cornerWidth.minus(lineWidth)) / 2)
            val cornerExtension: Float = cornerWidth / 2 + cornerOffset
