...
class FilterTouchListener(
    private val mView: View, private val viewHeight: Float,
    private val mainImageView: ImageView, private val photoEditorView: PhotoEditorView, private val filterLabel: View,
